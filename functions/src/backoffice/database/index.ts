...
export const SubscriptionsCollection = db
  ...
  .withConverter<ISubscriptionEntity>({
    ...
    toFirestore(
      object: ISubscriptionEntity | Partial<ISubscriptionEntity>,
    ): FirebaseFirestore.DocumentData {
      return object;
    },
  });

export const PayoutsCollection = db
  ...
  .withConverter<IPayoutEntity>({
    ...
    toFirestore(
      object: IPayoutEntity | Partial<IPayoutEntity>,
    ): FirebaseFirestore.DocumentData {
      return object;
    },
  });

export const CommonCollection = db
  .collection(Collections.Commons)
  .withConverter<ICommonEntity>({
    ...
    toFirestore(
      object: ICommonEntity | Partial<ICommonEntity>,
    ): FirebaseFirestore.DocumentData {
      return object;
    },
  });
...
export const ProposalsCollection = db
  ...
  .withConverter<IProposalEntity>({
    ...
    toFirestore(
      object: IProposalEntity | Partial<IProposalEntity>,
    ): FirebaseFirestore.DocumentData {
      return object;
    },
  });
...
export const UsersCollection = db
  ...
  .withConverter<IUserEntity>({
    ...
    toFirestore(
      object: IUserEntity | Partial<IUserEntity>,
    ): FirebaseFirestore.DocumentData {
      return object;
    },
  });
